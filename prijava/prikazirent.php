...
<ul class="nav justify-content-end" style="background-color:rgba(150, 137, 137, 0.192)">
  ...
  <li class="nav-item">
    ...
    <div class="prikazirentauto">
      <h3>Prikaz svih automobila za rentiranje</h3>
    <?php 
    
      $upitrent1 = "SELECT * FROM `rent_auto`";
      ...
      foreach($rent as $rentiranje){
        echo "<table class=\"table\">";
            ...
            echo "<tbody>";
              ...
              echo "<td></td>";
              echo "<td></td>";
              echo "<td  style=\"text-align:center;\"><a href=\"./phpex/deleterent.php?id=".$rentiranje["id_rent"]."\" class=\"btn btn-danger\">Obrisi</a></td>";
              echo "<td  style=\"text-align:center;\"><a href=\"./phpex/updaterent.php?id=".$rentiranje["id_rent"]."\" class=\"btn btn-primary\">Izmeni</a></td>";
              echo "</tr>";
